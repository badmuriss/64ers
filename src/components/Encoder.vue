  ...
  <div class="w-full max-w-2xl mx-auto p-6">
    ...
    <div class="flex justify-center items-center space-x-4 text-gray-400 mb-6">
      ...
      <label class="relative inline-flex items-center cursor-pointer">
        ...
        <div class="w-14 h-7 bg-gray-700 rounded-full peer-checked:bg-violet-500 transition-colors duration-300"></div>
    ...
    <!-- Card -->
    <div class="bg-gray-900 p-6 rounded-xl shadow-lg space-y-6">
      <!-- Encode Area -->
      <div v-show="!isDecodeMode" class="space-y-2">
        <div @click="triggerFileInput" @dragover.prevent @drop.prevent="handleDrop"
             class="border-4 border-dashed border-violet-500 rounded-lg p-8 flex items-center justify-center text-gray-400 hover:border-violet-400 transition-colors">
      ...
      <div v-show="isDecodeMode">
        <textarea v-model="base64Text" placeholder="Paste Base64 text..."
                  class="w-full h-48 bg-gray-700 text-gray-200 border border-gray-600 rounded-lg p-4 placeholder-gray-500 resize-none focus:ring-2 focus:ring-violet-400 transition duration-200">
        </textarea>
      </div>
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="flex-1 bg-gray-900 rounded-full h-1 overflow-hidden">
...
async function process() {
  ...
  if (!isDecodeMode.value) {
    ...
    try {
      ...
      const mime = guessMimeType(base64Text.value)
